import{hT as m,hU as P,hV as v,bf as f,hW as u,hX as y,hY as O,hZ as A,h_ as $,hv as r,h$ as g,i0 as S,i1 as c,i2 as C,aQ as E,i3 as x,i4 as _,aJ as o,i5 as n,i6 as d,i7 as b,i8 as w,i9 as N,ia as D,ib as M,ic as R,id as I,ie as F,ig as L,ih as U,ii as W,ij as B,ik as G,il as j,im as z,io as H,ip as q,hw as p,iq as Q,ir as V,is as k,it as J}from"./index-2d893400.js";function X(a){const e=new m,{vertex:t,fragment:s}=e;return P(t,a),e.include(v,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(u`
    void main(void) {
      vpos = position;
